    ...
    protected void InitializeVerbs() 
    {
        ...
        verbsList = new ReorderableList(serializedObject, verbs_serialized, true, true, false, false)
        {
            ...
            drawElementCallback = (rect, indexV, active, focus) =>
            {
                ...
                verbExpanded.boolValue = EditorGUI.Foldout(new Rect(verbRect.x, verbRect.y, verbRect.width, EditorGUIUtility.singleLineHeight), verbExpanded.boolValue, verb.FindPropertyRelative("name").stringValue);
